const perguntas = [
    { 
        ...
        opcoes: ["Luis Eulalio de Bueno Vidigal Filho", "Luis Eulalio", "Luiz de Bueno", "Luis Eulalio de Vidigal"],
        correta: 0
    },
    {
        pergunta: "Qual o nome do nosso curso?",
        opcoes: ["Analise e Desenvolvimento de Sistemas", "Sistemas de informação", "Desenvolvimento de sistemas", "Ciencia da Computação"],
        correta: 2       
    },
    {
